...
fixPage('src/app/(blog)/privacy/page.tsx', 'Privacy Policy');
fixPage('src/app/(blog)/terms/page.tsx', 'Terms of Service');
fixPage('src/app/(blog)/disclaimer/page.tsx', 'Disclaimer');
